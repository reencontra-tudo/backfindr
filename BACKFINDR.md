...
- **Diversificação de conteúdo local (itens A/B/C/D, status em 21/08/2026 — fechamento da sessão):**
...
- **Item D pendente**: dados locais (A/B/C) já existem completos ou quase completos, mas ainda não estão ligados na renderização das páginas de cidade/categoria.
