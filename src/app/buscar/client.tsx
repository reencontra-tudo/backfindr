                    ...
                    <div key={item.id} className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-4 flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2 mb-1">
                          ...
                          <span className="flex items-center gap-1 text-xs px-2 py-0.5 rounded-full border flex-shrink-0 text-teal-400 bg-teal-500/10 border-teal-500/20">
                            <CheckCircle className="w-3 h-3" />
                            Encontrado pela rede
                          </span>
                        </div>
                        {item.description && (
                        ...
                        {/* Botão "É o meu?" */}
                        <Link
                          href={item.code ? `/objeto/${item.code}` : `/auth/register?intent=lost`}
                          className="inline-flex items-center gap-1 text-xs text-teal-400 hover:text-teal-300 font-semibold transition-colors"
                        >
                          É o meu? <ArrowRight className="w-3 h-3" />
                        </Link>
                      </div>
                    </div>
                  ))}
