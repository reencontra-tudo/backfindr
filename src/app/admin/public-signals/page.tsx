...
import { Radar, Newspaper, Building2, Megaphone, CheckCircle2, XCircle, RefreshCw, Loader2, ExternalLink, MapPin, ShieldAlert } from 'lucide-react';
...
interface Evidence {
  id: string;
  source_url: string;
  source_type: 'press_rss' | 'institution' | 'google_alert_corroboration';
