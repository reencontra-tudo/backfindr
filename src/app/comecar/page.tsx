      ...
      <section className="relative flex min-h-screen sm:h-full flex-col items-center justify-center px-5 py-6 sm:py-8">
        ...
        <div className="relative mx-auto w-full max-w-3xl text-center">
          <FadeIn>
            ...
            <p className="mb-5 inline-flex items-center gap-2 rounded-full border border-blue-400/25 bg-blue-400/[0.08] px-4 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-blue-200/70 mb-3 sm:mb-5">
            ...
            <p className="mx-auto mb-6 sm:mb-8 max-w-xl text-sm sm:text-base leading-relaxed text-white/50 md:text-lg">
              Perdeu, encontrou, foi roubado ou quer se proteger — escolha abaixo e resolva em segundos.
            </p>
